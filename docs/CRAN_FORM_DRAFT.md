...
On 2026-09-25, `nirs4all_0.4.0.9020.tar.gz` passed Linux/R 4.6.0 checks with
...
fresh Linux R library, but that is not a multi-OS check of the exact 0.4.0.9020
